...
* 0.10.2.1 (Java OpenJDK 8, Scala 2.11) [Dockerfile](https://raw.githubusercontent.com/christiangda/docker-kafka/master/Dockerfile) --> [Build Procedure](docs/builds.md#"Tags: openjdk-8-2.11-0.10.2.1, 2.11-0.10.2.1, 0.10.2.1 (Default)")
